...
func mountInfra(app *zip.App) {
	...
	opPost(g, "/hosts/list", hostList)

	opGet(g, "/processes/attribute_keys", processAttributeKeys)
	opGet(g, "/processes/attribute_values", processAttributeValues)
	opPost(g, "/processes/list", processList)

	opGet(g, "/pods/attribute_keys", podAttributeKeys)
	opGet(g, "/pods/attribute_values", podAttributeValues)
	opPost(g, "/pods/list", podList)

	opGet(g, "/pvcs/attribute_keys", pvcAttributeKeys)
	opGet(g, "/pvcs/attribute_values", pvcAttributeValues)
	opPost(g, "/pvcs/list", pvcList)

	opGet(g, "/nodes/attribute_keys", nodeAttributeKeys)
	opGet(g, "/nodes/attribute_values", nodeAttributeValues)
	opPost(g, "/nodes/list", nodeList)

	opGet(g, "/namespaces/attribute_keys", namespaceAttributeKeys)
	opGet(g, "/namespaces/attribute_values", namespaceAttributeValues)
	opPost(g, "/namespaces/list", namespaceList)

	opGet(g, "/clusters/attribute_keys", clusterAttributeKeys)
	opGet(g, "/clusters/attribute_values", clusterAttributeValues)
	opPost(g, "/clusters/list", clusterList)

	opGet(g, "/deployments/attribute_keys", deploymentAttributeKeys)
	opGet(g, "/deployments/attribute_values", deploymentAttributeValues)
	opPost(g, "/deployments/list", deploymentList)

	opGet(g, "/daemonsets/attribute_keys", daemonSetAttributeKeys)
	opGet(g, "/daemonsets/attribute_values", daemonSetAttributeValues)
	opPost(g, "/daemonsets/list", daemonSetList)

	opGet(g, "/statefulsets/attribute_keys", statefulSetAttributeKeys)
	opGet(g, "/statefulsets/attribute_values", statefulSetAttributeValues)
	opPost(g, "/statefulsets/list", statefulSetList)

	opGet(g, "/jobs/attribute_keys", jobAttributeKeys)
	opGet(g, "/jobs/attribute_values", jobAttributeValues)
	opPost(g, "/jobs/list", jobList)

	opPost(g, "/infra_monitoring/hosts", infraHosts)
	opPost(g, "/infra_monitoring/pods", infraPods)
	opPost(g, "/infra_monitoring/nodes", infraNodes)
	opPost(g, "/infra_monitoring/namespaces", infraNamespaces)
	opPost(g, "/infra_monitoring/clusters", infraClusters)
	opPost(g, "/infra_monitoring/pvcs", infraVolumes)
	opPost(g, "/infra_monitoring/deployments", infraDeployments)
	opPost(g, "/infra_monitoring/statefulsets", infraStatefulSets)
	opPost(g, "/infra_monitoring/jobs", infraJobs)
	opPost(g, "/infra_monitoring/daemonsets", infraDaemonSets)
	opGet(g, "/infra_monitoring/checks", infraChecks)
}
