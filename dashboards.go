...
func mountDashboards(app *zip.App) {
	...
	g.Get("/dashboards", dashboardListV2, zip.WithOperationID("ListDashboardsV2"))
	g.Get("/users/me/dashboards", dashboardListForUserV2, zip.WithOperationID("ListDashboardsForUserV2"))
	g.Post("/dashboards", dashboardCreateV2, zip.WithStatus(http.StatusCreated), zip.WithOperationID("CreateDashboardV2"))
	g.Post("/dashboards/:id/clone", dashboardCloneV2, zip.WithStatus(http.StatusCreated), zip.WithOperationID("CloneDashboardV2"))
	g.Get("/dashboards/:id", dashboardGetV2, zip.WithOperationID("GetDashboardV2"))
	g.Put("/dashboards/:id", dashboardUpdateV2, zip.WithOperationID("UpdateDashboardV2"))
	g.Patch("/dashboards/:id", dashboardPatchV2, zip.WithOperationID("PatchDashboardV2"))
	g.Delete("/dashboards/:id", dashboardDeleteV2, zip.WithOperationID("DeleteDashboardV2"))

	// Lock / unlock — only the creator or an org admin; the runtime decides.
	g.Put("/dashboards/:id/lock", dashboardLockV2, zip.WithOperationID("LockDashboardV2"))
	g.Delete("/dashboards/:id/lock", dashboardUnlockV2, zip.WithOperationID("UnlockDashboardV2"))

	// Per-user pins — a viewer bookmark, mutating only the caller's pin list.
	g.Put("/users/me/dashboards/:id/pins", dashboardPinV2, zip.WithOperationID("PinDashboardV2"))
	g.Delete("/users/me/dashboards/:id/pins", dashboardUnpinV2, zip.WithOperationID("UnpinDashboardV2"))

	// Saved views — org-shared dashboard-listing state.
	g.Get("/dashboard_views", dashboardListViews, zip.WithOperationID("ListDashboardViews"))
	g.Post("/dashboard_views", dashboardCreateView, zip.WithStatus(http.StatusCreated), zip.WithOperationID("CreateDashboardView"))
	g.Put("/dashboard_views/:id", dashboardUpdateView, zip.WithOperationID("UpdateDashboardView"))
	g.Delete("/dashboard_views/:id", dashboardDeleteView, zip.WithOperationID("DeleteDashboardView"))

	// Public sharing config — org-admin only.
	g.Post("/dashboards/:id/public", dashboardCreatePublic, zip.WithStatus(http.StatusCreated), zip.WithOperationID("CreatePublicDashboard"))
	g.Get("/dashboards/:id/public", dashboardGetPublic, zip.WithOperationID("GetPublicDashboard"))
	g.Put("/dashboards/:id/public", dashboardUpdatePublic, zip.WithOperationID("UpdatePublicDashboard"))
	g.Delete("/dashboards/:id/public", dashboardDeletePublic, zip.WithOperationID("DeletePublicDashboard"))

	// Anonymous public reads — scoped to the public dashboard's read scope.
	g.Get("/public/dashboards/:id", dashboardGetPublicData, zip.WithOperationID("GetPublicDashboardData"))
	g.Get("/public/dashboards/:id/widgets/:idx/query_range", dashboardGetPublicWidgetQueryRange, zip.WithOperationID("GetPublicDashboardWidgetQueryRange"))
}
...
func dashboardListV2(ctx context.Context, in *O11yDashboardListParams) (*O11yDashboardListOut, error) {
	...
	return out, relay(ctx, listParams(in), nil, out)
}
...
func dashboardUpdateV2(ctx context.Context, in *O11yDashboardUpdateIn) (*O11yDashboardOut, error) {
	out := new(O11yDashboardOut)
	return out, relay(ctx, nil, in.O11yDashboardUpdatable, out)
}
...
func dashboardPatchV2(ctx context.Context, in *O11yDashboardPatchIn) (*O11yDashboardOut, error) {
	...
	return out, relay(ctx, nil, in.Ops, out)
}
...
func dashboardUpdateView(ctx context.Context, in *O11yDashboardViewUpdateIn) (*O11yDashboardViewOut, error) {
	out := new(O11yDashboardViewOut)
	return out, relay(ctx, nil, in.O11yDashboardViewPostable, out)
}
...
func dashboardCreatePublic(ctx context.Context, in *O11yPublicDashboardWriteIn) (*O11yIdentifiableOut, error) {
	...
	return out, relay(ctx, nil, in.O11yPublicDashboardWrite, out)
}
...
func dashboardUpdatePublic(ctx context.Context, in *O11yPublicDashboardWriteIn) (*struct{}, error) {
	return nil, relay(ctx, nil, in.O11yPublicDashboardWrite, nil)
}
...
func dashboardGetPublicWidgetQueryRange(ctx context.Context, in *O11yWidgetQueryRangeIn) (*O11yWidgetQueryRangeOut, error) {
	...
	return out, relay(ctx, query("startTime", in.StartTime, "endTime", in.EndTime), nil, out)
}
