...
def test_get_user_preference(
    ...
    response = requests.get(
        o11y.self.host_configs["8080"].get("/v1/o11y/user/preferences"),
...
def test_get_set_user_preference_by_name(
    ...
    response = requests.get(
        o11y.self.host_configs["8080"].get("/v1/o11y/user/preferences/somenonexistentpreference"),
        headers={"Authorization": f"Bearer {admin_token}"},
        timeout=2,
    )
    ...
    response = requests.get(
        o11y.self.host_configs["8080"].get("/v1/o11y/user/preferences/welcome_checklist_do_later"),
        headers={"Authorization": f"Bearer {admin_token}"},
        timeout=2,
    )
