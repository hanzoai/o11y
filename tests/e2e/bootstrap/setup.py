...
def _env_file(pytestconfig: pytest.Config) -> Path:
    override = os.environ.get("O11Y_E2E_ENV_FILE")
    if override:
...
def test_setup(
    ...
    host_cfg = o11y.self.host_configs["8080"]
    ...
    with out.open("w") as f:
        ...
        f.write(f"O11Y_E2E_BASE_URL={host_cfg.base()}\n")
        f.write(f"O11Y_E2E_USERNAME={USER_ADMIN_EMAIL}\n")
        f.write(f"O11Y_E2E_PASSWORD={USER_ADMIN_PASSWORD}\n")
        f.write(f"O11Y_E2E_SEEDER_URL={seeder_cfg.base()}\n")
