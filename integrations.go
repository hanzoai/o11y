...
func mountIntegrations(app *zip.App) {
	...
	opGet(g, "/integrations", listIntegrations, zip.WithOperationID("ListIntegrations"))
	opGet(g, "/integrations/:integrationId", getIntegration, zip.WithOperationID("GetIntegration"))
	opGet(g, "/integrations/:integrationId/connection_status", getIntegrationConnectionStatus, zip.WithOperationID("GetIntegrationConnectionStatus"))
	opPost(g, "/integrations/install", installIntegration, zip.WithOperationID("InstallIntegration"))
	opPost(g, "/integrations/uninstall", uninstallIntegration, zip.WithOperationID("UninstallIntegration"))

	// cloud integrations — accounts and services (runtime gate: AdminAccess)
	opGet(g, "/cloud_integrations/:cloud_provider/credentials", getConnectionCredentials, zip.WithOperationID("GetConnectionCredentials"))
	opPost(g, "/cloud_integrations/:cloud_provider/accounts", createAccount, zip.WithStatus(http.StatusCreated), zip.WithOperationID("CreateAccount"))
	opGet(g, "/cloud_integrations/:cloud_provider/accounts", listAccounts, zip.WithOperationID("ListAccounts"))
	opGet(g, "/cloud_integrations/:cloud_provider/accounts/:id", getAccount, zip.WithOperationID("GetAccount"))
	opPut(g, "/cloud_integrations/:cloud_provider/accounts/:id", updateAccount, zip.WithOperationID("UpdateAccount"))
	opDelete(g, "/cloud_integrations/:cloud_provider/accounts/:id", disconnectAccount, zip.WithOperationID("DisconnectAccount"))
	opGet(g, "/cloud_integrations/:cloud_provider/services", listServicesMetadata, zip.WithOperationID("ListServicesMetadata"))
	opGet(g, "/cloud_integrations/:cloud_provider/accounts/:id/services", listAccountServicesMetadata, zip.WithOperationID("ListAccountServicesMetadata"))
	opGet(g, "/cloud_integrations/:cloud_provider/services/:service_id", getService, zip.WithOperationID("GetService"))
	opPut(g, "/cloud_integrations/:cloud_provider/accounts/:id/services/:service_id", updateService, zip.WithOperationID("UpdateService"))
	opGet(g, "/cloud_integrations/:cloud_provider/accounts/:id/services/:service_id", getAccountService, zip.WithOperationID("GetAccountService"))
	...
	opPost(g, "/cloud-integrations/:cloud_provider/agent-check-in", agentCheckInDeprecated, zip.WithOperationID("AgentCheckInDeprecated"))
	opPost(g, "/cloud_integrations/:cloud_provider/accounts/check_in", agentCheckIn, zip.WithOperationID("AgentCheckIn"))

	// gateway ingestion keys and their limits (runtime gate: EditAccess)
	opGet(g, "/gateway/ingestion_keys", getIngestionKeys, zip.WithOperationID("GetIngestionKeys"))
	opGet(g, "/gateway/ingestion_keys/search", searchIngestionKeys, zip.WithOperationID("SearchIngestionKeys"))
	opPost(g, "/gateway/ingestion_keys", createIngestionKey, zip.WithStatus(http.StatusCreated), zip.WithOperationID("CreateIngestionKey"))
	opPatch(g, "/gateway/ingestion_keys/:keyId", updateIngestionKey, zip.WithOperationID("UpdateIngestionKey"))
	opDelete(g, "/gateway/ingestion_keys/:keyId", deleteIngestionKey, zip.WithOperationID("DeleteIngestionKey"))
	opPost(g, "/gateway/ingestion_keys/:keyId/limits", createIngestionKeyLimit, zip.WithStatus(http.StatusCreated), zip.WithOperationID("CreateIngestionKeyLimit"))
	opPatch(g, "/gateway/ingestion_keys/limits/:limitId", updateIngestionKeyLimit, zip.WithOperationID("UpdateIngestionKeyLimit"))
	opDelete(g, "/gateway/ingestion_keys/limits/:limitId", deleteIngestionKeyLimit, zip.WithOperationID("DeleteIngestionKeyLimit"))

	// Zeus — deployment profile and host (runtime gate: AdminAccess writes, ViewAccess read)
	opPut(g, "/zeus/profiles", putProfile, zip.WithOperationID("PutProfile"))
	opGet(g, "/zeus/hosts", getHosts, zip.WithOperationID("GetHosts"))
	opPut(g, "/zeus/hosts", putHost, zip.WithOperationID("PutHost"))
}
...
func listIntegrations(ctx context.Context, in *O11yListIntegrationsIn) (*O11yIntegrationsListOut, error) {
	...
	return out, relay(ctx, query("is_installed", in.IsInstalled), nil, out)
}
...
func getIntegrationConnectionStatus(ctx context.Context, in *O11yConnectionStatusIn) (*O11yConnectionStatusOut, error) {
	...
	return out, relay(ctx, query("lookback_seconds", in.LookbackSeconds), nil, out)
}
...
func listServicesMetadata(ctx context.Context, in *O11yListServicesMetadataIn) (*O11yServicesMetadataOut, error) {
	...
	return out, relay(ctx, query("cloud_integration_id", in.CloudIntegrationID), nil, out)
}
...
func getIngestionKeys(ctx context.Context, in *O11yIngestionKeysIn) (*O11yIngestionKeysOut, error) {
	...
	return out, relay(ctx, query("page", in.Page, "per_page", in.PerPage), nil, out)
}
...
func searchIngestionKeys(ctx context.Context, in *O11ySearchIngestionKeysIn) (*O11yIngestionKeysOut, error) {
	out := new(O11yIngestionKeysOut)
	return out, relay(ctx, query("name", in.Name, "page", in.Page, "per_page", in.PerPage), nil, out)
}
