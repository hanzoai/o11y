...
func TestSortRows(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			builderQueries: map[string]*v3.BuilderQuery{
				"A": {OrderBy: []v3.OrderBy{{ColumnName: constants.O11yOrderByValue, Order: "asc"}}},
			},
			queryNames: []string{"A"},
			expected: []*v3.TableRow{
				{Data: map[string]interface{}{"service": "service1", "A": 10.0}},
		...
		},
		{
			...
			builderQueries: map[string]*v3.BuilderQuery{
				"A": {OrderBy: []v3.OrderBy{{ColumnName: constants.O11yOrderByValue, Order: "desc"}}},
			},
			queryNames: []string{"A"},
			expected: []*v3.TableRow{
				{Data: map[string]interface{}{"service": "service3", "A": 30.0}},
		...
		},
		{
			...
			builderQueries: map[string]*v3.BuilderQuery{
				"A": {OrderBy: []v3.OrderBy{{ColumnName: constants.O11yOrderByValue, Order: "asc"}}},
				"B": {OrderBy: []v3.OrderBy{{ColumnName: constants.O11yOrderByValue, Order: "desc"}}},
			},
		...
		{
			name: "Sort with O11yOrderByValue",
			rows: []*v3.TableRow{
