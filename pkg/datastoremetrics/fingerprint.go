...
// datastore metrics schema uses to join a sample (event.metric) to its series
// metadata (event.series). It is a plain FNV-1a walk over the sorted
...
// column of both event.metric and event.series.
