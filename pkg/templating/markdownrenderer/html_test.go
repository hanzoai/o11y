...
https://o11y.example.com/alerts/123
...
[View Alert in O11y](https://o11y.example.com/alerts/123) | [View Logs](https://o11y.example.com/logs?service=api-gateway) | [View Traces](https://o11y.example.com/traces?service=api-gateway)

![critical](https://o11y.example.com/badges/critical.svg "Critical Alert")
...
This alert was generated by O11y using ` + "`alertmanager`" + ` rules engine.
`
...
func TestRenderHTML_Composite(t *testing.T) {
	...
	expected := "<h1>🔥 FIRING: High CPU Usage on api-gateway</h1>\n" +
		...
		"<p><a href=\"https://o11y.example.com/alerts/123\">View Alert in O11y</a> | <a href=\"https://o11y.example.com/logs?service=api-gateway\">View Logs</a> | <a href=\"https://o11y.example.com/traces?service=api-gateway\">View Traces</a></p>\n" +
		"<p><img src=\"https://o11y.example.com/badges/critical.svg\" alt=\"critical\" title=\"Critical Alert\"></p>\n" +
		"<h2>Alert Labels</h2>\n" +
		"<table>\n<thead>\n<tr>\n<th>Label</th>\n<th>Value</th>\n</tr>\n</thead>\n" +
		"<tbody>\n<tr>\n<td>service</td>\n<td>api-gateway</td>\n</tr>\n" +
		"<tr>\n<td>instance</td>\n<td>pod-5a8b3c</td>\n</tr>\n" +
		...
		"<p>This alert was generated by O11y using <code>alertmanager</code> rules engine.</p>\n"
...
Metric ` + "`cpu_usage_percent`" + ` exceeded threshold. [View in O11y](https://o11y.example.com/alerts/123)
...
![critical](https://o11y.example.com/badges/critical.svg "Critical Alert")`
	...
	expected := "<h1>🔥 FIRING: High CPU on api-gateway</h1>\n<h2>Alert Status</h2>\n" +
		...
		"<p>Metric <code>cpu_usage_percent</code> exceeded threshold. <a href=\"https://o11y.example.com/alerts/123\">View in O11y</a></p>\n" +
		"<p><img src=\"https://o11y.example.com/badges/critical.svg\" alt=\"critical\" title=\"Critical Alert\"></p>\n"
