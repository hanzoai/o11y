...
func TestNewWithEnvProvider(t *testing.T) {
	t.Setenv("O11Y_TELEMETRYSTORE_CLICKHOUSE_DSN", "tcp://localhost:9000")
	...
	t.Setenv("O11Y_TELEMETRYSTORE_CLICKHOUSE_DEBUG", "true")
...
func TestNewWithEnvProviderWithQuerySettings(t *testing.T) {
	t.Setenv("O11Y_TELEMETRYSTORE_CLICKHOUSE_SETTINGS_MAX__EXECUTION__TIME", "10")
	t.Setenv("O11Y_TELEMETRYSTORE_CLICKHOUSE_SETTINGS_MAX__EXECUTION__TIME__LEAF", "10")
	t.Setenv("O11Y_TELEMETRYSTORE_CLICKHOUSE_SETTINGS_TIMEOUT__BEFORE__CHECKING__EXECUTION__SPEED", "10")
	t.Setenv("O11Y_TELEMETRYSTORE_CLICKHOUSE_SETTINGS_MAX__BYTES__TO__READ", "1000000")
	t.Setenv("O11Y_TELEMETRYSTORE_CLICKHOUSE_SETTINGS_MAX__RESULT__ROWS", "10000")
