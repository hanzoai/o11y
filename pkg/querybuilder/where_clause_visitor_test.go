...
func TestVisitKey(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			expectedMainErrURL: "https://o11y.io/docs/userguide/search-troubleshooting/#key-fieldname-not-found",
			expectedWarnings:   nil,
			expectedMainWrnURL: "",
		},
		{
			...
			expectedMainWrnURL: "https://o11y.io/docs/userguide/field-context-data-types/",
		},
