...
import (
	...
	"github.com/hanzoai/o11y/pkg/types/parsertypes"
...
func TestAPI_AnalyzeQueryFilter(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Create HTTP request
			req := httptest.NewRequestWithContext(context.Background(), http.MethodPost, "/v1/o11y/query_filter/analyze", bytes.NewBuffer(reqBody))
