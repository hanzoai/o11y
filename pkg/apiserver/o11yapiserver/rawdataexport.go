...
func (provider *provider) addRawDataExportRoutes(router *mux.Router) error {
	...
	if err := router.Handle("/v1/o11y/v1/export_raw_data", handler.New(provider.authzMiddleware.ViewAccess(provider.rawDataExportHandler.ExportRawData), handler.OpenAPIDef{
