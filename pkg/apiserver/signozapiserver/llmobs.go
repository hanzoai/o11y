...
func (provider *provider) addLLMObsRoutes(router *mux.Router) error {
	...
	routes := []struct {
		...
		{http.MethodGet, "/v1/o11y/observations", provider.authzMiddleware.ViewAccess(h.Observations), handler.OpenAPIDef{
		...
		{http.MethodGet, "/v1/o11y/traces", provider.authzMiddleware.ViewAccess(h.Traces), handler.OpenAPIDef{
		...
		{http.MethodGet, "/v1/o11y/sessions", provider.authzMiddleware.ViewAccess(h.Sessions), handler.OpenAPIDef{
		...
		{http.MethodGet, "/v1/o11y/users", provider.authzMiddleware.ViewAccess(h.Users), handler.OpenAPIDef{
		...
		{http.MethodGet, "/v1/o11y/scores", provider.authzMiddleware.ViewAccess(h.ListScores), handler.OpenAPIDef{
		...
		{http.MethodPost, "/v1/o11y/scores", provider.authzMiddleware.EditAccess(h.CreateScore), handler.OpenAPIDef{
		...
		{http.MethodGet, "/v1/o11y/score/{id}", provider.authzMiddleware.ViewAccess(h.GetScore), handler.OpenAPIDef{
		...
		{http.MethodDelete, "/v1/o11y/score/{id}", provider.authzMiddleware.EditAccess(h.DeleteScore), handler.OpenAPIDef{
		...
		{http.MethodGet, "/v1/o11y/annotation", provider.authzMiddleware.ViewAccess(h.Annotations), handler.OpenAPIDef{
		...
		{http.MethodPost, "/v1/o11y/annotation", provider.authzMiddleware.EditAccess(h.CreateAnnotation), handler.OpenAPIDef{
