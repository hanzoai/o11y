...
func TestConditionFor(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			name: "Greater Than Or Equal operator - time",
			key: telemetrytypes.TelemetryFieldKey{
				Name:         "time",
				FieldContext: telemetrytypes.FieldContextSpan,
			},
		...
		{
			name: "Less Than Or Equal operator - time",
			key: telemetrytypes.TelemetryFieldKey{
				Name:         "time",
				FieldContext: telemetrytypes.FieldContextSpan,
			},
		...
		{
			name: "Not Between operator - time",
			key: telemetrytypes.TelemetryFieldKey{
				Name:         "time",
				FieldContext: telemetrytypes.FieldContextSpan,
			},
