...
func TestGetFieldKeyName(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			expectedResult: "toBool(attributes['request.success'] = 'true')",
			expectedError:  nil,
		},
		{
		...
		{
			// Query like `attribute.attribute_string:string` should resolve to `attributes['attribute_string']`.
