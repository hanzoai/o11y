...
func NewAvailablePreference() map[Name]Preference {
	return map[Name]Preference{
		...
		NameSpanDetailsPreviewAttributes: {
			Name:          NameSpanDetailsPreviewAttributes,
			Description:   "List of preview attributes in span tooltip.",
			ValueType:     ValueTypeArray,
			DefaultValue:  MustNewValue([]any{}, ValueTypeArray),
			AllowedScopes: []Scope{ScopeUser},
			AllowedValues: []string{},
		...
		NameSpanDetailsColorByAttribute: {
			Name:          NameSpanDetailsColorByAttribute,
			Description:   "Attribute used to color spans in span details.",
			ValueType:     ValueTypeString,
			DefaultValue:  MustNewValue("", ValueTypeString),
			AllowedScopes: []Scope{ScopeUser},
			AllowedValues: []string{},
