...
func TestNewAuditEvent(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			route:           "/v1/o11y/dashboards",
			statusCode:      http.StatusOK,
			action:          coretypes.VerbCreate,
			category:        coretypes.ActionCategoryConfigurationChange,
			claims:          authtypes.Claims{UserID: "019a1234-abcd-7000-8000-567800000001", Email: "alice@acme.com", OrgID: "019a-0000-0000-0001", IdentNProvider: authtypes.IdentNProviderIAM},
		...
		},
		{
			...
			path:            "/v1/o11y/dashboards/019b-5678-efgh-9012",
			route:           "/v1/o11y/dashboards/{id}",
			statusCode:      http.StatusForbidden,
			action:          coretypes.VerbUpdate,
			category:        coretypes.ActionCategoryConfigurationChange,
			claims:          authtypes.Claims{UserID: "019aaaaa-bbbb-7000-8000-cccc00000002", Email: "viewer@acme.com", OrgID: "019a-0000-0000-0001", IdentNProvider: authtypes.IdentNProviderIAM},
			resource:        testDashboardResource,
			resourceID:      "019b-5678-efgh-9012",
			errorType:       "forbidden",
