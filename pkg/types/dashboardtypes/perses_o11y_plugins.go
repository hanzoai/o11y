...
// ══════════════════════════════════════════════
// O11y variable plugin specs
// ══════════════════════════════════════════════

type VariablePluginKind string

const (
	VariableKindDynamic VariablePluginKind = "o11y/DynamicVariable"
	VariableKindQuery   VariablePluginKind = "o11y/QueryVariable"
	VariableKindCustom  VariablePluginKind = "o11y/CustomVariable"
)
...
// ══════════════════════════════════════════════
// O11y query plugin specs — aliased from querybuildertypesv5
// ══════════════════════════════════════════════

type QueryPluginKind string

const (
	QueryKindBuilder       QueryPluginKind = "o11y/BuilderQuery"
...
// PrepareJSONSchema marks the envelope with x-o11y-discriminator keyed on
...
func (BuilderQuerySpec) PrepareJSONSchema(s *jsonschema.Schema) error {
	return markDiscriminator(s, "signal", map[string]string{
		telemetrytypes.SignalLogs.StringValue():    schemaRef("Querybuildertypesv5QueryBuilderQueryGithubComO11yO11yPkgTypesQuerybuildertypesQuerybuildertypesv5LogAggregation"),
		telemetrytypes.SignalMetrics.StringValue(): schemaRef("Querybuildertypesv5QueryBuilderQueryGithubComO11yO11yPkgTypesQuerybuildertypesQuerybuildertypesv5MetricAggregation"),
		telemetrytypes.SignalTraces.StringValue():  schemaRef("Querybuildertypesv5QueryBuilderQueryGithubComO11yO11yPkgTypesQuerybuildertypesQuerybuildertypesv5TraceAggregation"),
	})
}
...
// ══════════════════════════════════════════════
// O11y panel plugin specs
// ══════════════════════════════════════════════

type PanelPluginKind string

const (
	PanelKindTimeSeries PanelPluginKind = "o11y/TimeSeriesPanel"
	PanelKindBarChart   PanelPluginKind = "o11y/BarChartPanel"
	PanelKindNumber     PanelPluginKind = "o11y/NumberPanel"
	PanelKindPieChart   PanelPluginKind = "o11y/PieChartPanel"
	PanelKindTable      PanelPluginKind = "o11y/TablePanel"
	PanelKindHistogram  PanelPluginKind = "o11y/HistogramPanel"
	PanelKindList       PanelPluginKind = "o11y/ListPanel"
)
...
const (
	DatasourceKindO11y DatasourcePluginKind = "o11y/Datasource"
)

func (DatasourcePluginKind) Enum() []any {
	return []any{DatasourceKindO11y}
}

// O11yDatasourceSpec is the (empty) o11y/Datasource plugin spec. Naming the
// type gives the variant a concrete, non-nullable spec schema instead of an
// inline free-form one.
type O11yDatasourceSpec struct{}
