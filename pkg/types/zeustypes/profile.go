...
type PostableProfile struct {
	...
	ReasonsForInterestInO11y     []string `json:"reasons_for_interest_in_o11y" required:"true"`
	...
	WhereDidYouDiscoverO11y      string   `json:"where_did_you_discover_o11y" required:"true"`
	TimelineForMigratingToO11y   string   `json:"timeline_for_migrating_to_o11y" required:"true"`
}
