...
type PostableProfile struct {
	...
	ReasonsForInterestInHanzo O11y   []string `json:"reasons_for_interest_in_o11y" required:"true"`
	...
	WhereDidYouDiscoverHanzo O11y    string   `json:"where_did_you_discover_o11y" required:"true"`
	TimelineForMigratingToHanzo O11y string   `json:"timeline_for_migrating_to_o11y" required:"true"`
}
