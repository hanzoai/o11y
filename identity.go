...
func mountIdentity(app *zip.App) {
	...
	opPost(g, "/invite", createInvite, zip.WithStatus(http.StatusCreated), zip.WithOperationID("CreateInvite"))
	opPost(g, "/invite/bulk", createBulkInvite, zip.WithStatus(http.StatusCreated), zip.WithOperationID("CreateBulkInvite"))
	opGet(g, "/user", listUsersDeprecated, zip.WithOperationID("ListUsersDeprecated"))
	opGet(g, "/users", listUsers, zip.WithOperationID("ListUsers"))
	opGet(g, "/user/me", getMyUserDeprecated, zip.WithOperationID("GetMyUserDeprecated"))
	opGet(g, "/users/me", getMyUser, zip.WithOperationID("GetMyUser"))
	opPost(g, "/users", createUser, zip.WithStatus(http.StatusCreated), zip.WithOperationID("CreateUser"))
	opPut(g, "/users/me", updateMyUser, zip.WithOperationID("UpdateMyUserV2"))
	opGet(g, "/user/:id", getUserDeprecated, zip.WithOperationID("GetUserDeprecated"))
	opGet(g, "/users/:id", getUser, zip.WithOperationID("GetUser"))
	opPut(g, "/user/:id", updateUserDeprecated, zip.WithOperationID("UpdateUserDeprecated"))
	opPut(g, "/users/:id", updateUser, zip.WithOperationID("UpdateUser"))
	opDelete(g, "/user/:id", deleteUserDeprecated, zip.WithOperationID("DeleteUserDeprecated"))
	opDelete(g, "/users/:id", deleteUser, zip.WithOperationID("DeleteUser"))

	// passwords and their reset tokens
	opGet(g, "/getResetPasswordToken/:id", getResetTokenDeprecated, zip.WithOperationID("GetResetPasswordTokenDeprecated"))
	opGet(g, "/users/:id/reset_password_tokens", getResetToken, zip.WithOperationID("GetResetPasswordToken"))
	opPut(g, "/users/:id/reset_password_tokens", createResetToken, zip.WithStatus(http.StatusCreated), zip.WithOperationID("CreateResetPasswordToken"))
	opPost(g, "/reset_password_tokens/verify", verifyResetToken, zip.WithOperationID("VerifyResetPasswordToken"))
	opPost(g, "/resetPassword", resetPassword, zip.WithOperationID("ResetPassword"))
	opPut(g, "/users/me/factor_password", changeMyPassword, zip.WithOperationID("UpdateMyPassword"))
	opPost(g, "/factor_password/forgot", forgotPassword, zip.WithOperationID("ForgotPassword"))

	// roles on users
	opGet(g, "/users/:id/roles", listUserRoles, zip.WithOperationID("GetRolesByUserID"))
	opPost(g, "/users/:id/roles", setUserRole, zip.WithOperationID("SetRoleByUserID"))
	opDelete(g, "/users/:id/roles/:roleId", removeUserRole, zip.WithOperationID("RemoveUserRoleByUserIDAndRoleID"))
	opGet(g, "/roles/:id/users", listRoleUsers, zip.WithOperationID("GetUsersByRoleID"))
	...
	opPost(g, "/sessions/email_password", createEmailPasswordSession, zip.WithOperationID("CreateSessionByEmailPassword"))
	opGet(g, "/sessions/context", getSessionContext, zip.WithOperationID("GetSessionContext"))
	opPost(g, "/sessions/rotate", rotateSession, zip.WithOperationID("RotateSession"))
	opDelete(g, "/sessions", deleteSession, zip.WithOperationID("DeleteSession"))

	// auth domains
	opGet(g, "/domains", listAuthDomains, zip.WithOperationID("ListAuthDomains"))
	opPost(g, "/domains", createAuthDomain, zip.WithStatus(http.StatusCreated), zip.WithOperationID("CreateAuthDomain"))
	opGet(g, "/domains/:id", getAuthDomain, zip.WithOperationID("GetAuthDomain"))
	opPut(g, "/domains/:id", updateAuthDomain, zip.WithOperationID("UpdateAuthDomain"))
	opDelete(g, "/domains/:id", deleteAuthDomain, zip.WithOperationID("DeleteAuthDomain"))
