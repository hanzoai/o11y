...
export declare const Color: {
	...
	BG_SIENNA_700: string;
	BG_SIENNA_800: string;
	BG_SIENNA_850: string;
	BG_SIENNA_900: string;
	...
	BG_CHERRY_700: string;
	BG_CHERRY_800: string;
	BG_CHERRY_850: string;
	BG_CHERRY_900: string;
	...
	BG_SAKURA_150: string;
	BG_SAKURA_200: string;
	BG_SAKURA_300: string;
	BG_SAKURA_400: string;
	BG_SAKURA_500: string;
	BG_SAKURA_600: string;
	BG_SAKURA_700: string;
	BG_SAKURA_800: string;
	BG_SAKURA_850: string;
	BG_SAKURA_900: string;
	BG_SAKURA_950: string;
	BG_AMBER_50: string;
	BG_AMBER_100: string;
	BG_AMBER_150: string;
	BG_AMBER_200: string;
	...
	TEXT_SIENNA_700: string;
	TEXT_SIENNA_800: string;
	TEXT_SIENNA_850: string;
	TEXT_SIENNA_900: string;
	...
	TEXT_CHERRY_700: string;
	TEXT_CHERRY_800: string;
	TEXT_CHERRY_850: string;
	TEXT_CHERRY_900: string;
	...
	TEXT_AQUA_700: string;
	TEXT_AQUA_800: string;
	TEXT_AQUA_850: string;
	TEXT_AQUA_900: string;
	TEXT_AQUA_950: string;
	TEXT_SAKURA_50: string;
	TEXT_SAKURA_100: string;
	TEXT_SAKURA_150: string;
	TEXT_SAKURA_200: string;
	TEXT_SAKURA_300: string;
	TEXT_SAKURA_400: string;
	TEXT_SAKURA_500: string;
	TEXT_SAKURA_600: string;
	TEXT_SAKURA_700: string;
	TEXT_SAKURA_800: string;
	TEXT_SAKURA_850: string;
	TEXT_SAKURA_900: string;
	TEXT_SAKURA_950: string;
	TEXT_AMBER_50: string;
	TEXT_AMBER_100: string;
	TEXT_AMBER_150: string;
	TEXT_AMBER_200: string;
	TEXT_AMBER_300: string;
	TEXT_AMBER_400: string;
	TEXT_AMBER_500: string;
	TEXT_AMBER_600: string;
	TEXT_AMBER_700: string;
	TEXT_AMBER_800: string;
	TEXT_AMBER_850: string;
...
export declare const Style: {
	...
	readonly GHOST_BACKGROUND: 'var(--ghost-background)';
	readonly GHOST_BACKGROUND_HOVER: 'var(--ghost-background-hover)';
	readonly GHOST_FOREGROUND: 'var(--ghost-foreground)';
	readonly GHOST_FOREGROUND_HOVER: 'var(--ghost-foreground-hover)';
	readonly GHOST_BORDER: 'var(--ghost-border)';
	readonly ACTION_BACKGROUND: 'var(--action-background)';
	readonly ACTION_BACKGROUND_HOVER: 'var(--action-background-hover)';
	readonly ACTION_BORDER: 'var(--action-border)';
	readonly ACTION_BORDER_HOVER: 'var(--action-border-hover)';
	readonly ACTION_FOREGROUND: 'var(--action-foreground)';
	readonly ACTION_FOREGROUND_HOVER: 'var(--action-foreground-hover)';
	readonly CALLOUT_SIENNA_BACKGROUND: 'var(--callout-sienna-background)';
	readonly CALLOUT_SIENNA_BORDER: 'var(--callout-sienna-border)';
	readonly CALLOUT_SIENNA_TITLE: 'var(--callout-sienna-title)';
	readonly CALLOUT_SIENNA_DESCRIPTION: 'var(--callout-sienna-description)';
	readonly CALLOUT_SIENNA_ICON: 'var(--callout-sienna-icon)';
	readonly CALLOUT_AQUA_BACKGROUND: 'var(--callout-aqua-background)';
	readonly CALLOUT_AQUA_BORDER: 'var(--callout-aqua-border)';
	readonly CALLOUT_AQUA_TITLE: 'var(--callout-aqua-title)';
	readonly CALLOUT_AQUA_DESCRIPTION: 'var(--callout-aqua-description)';
	readonly CALLOUT_AQUA_ICON: 'var(--callout-aqua-icon)';
	readonly CONTROL_ICON_FOREGROUND: 'var(--control-icon-foreground)';
	readonly CONTROL_ICON_FOREGROUND_CONTRAST: 'var(--control-icon-foreground-contrast)';
};
...
export declare const StyleTailwind: {
	...
	readonly 'ghost-background': 'var(--ghost-background)';
	readonly 'ghost-background-hover': 'var(--ghost-background-hover)';
	readonly 'ghost-foreground': 'var(--ghost-foreground)';
	readonly 'ghost-foreground-hover': 'var(--ghost-foreground-hover)';
	readonly 'ghost-border': 'var(--ghost-border)';
	readonly 'action-background': 'var(--action-background)';
	readonly 'action-background-hover': 'var(--action-background-hover)';
	readonly 'action-border': 'var(--action-border)';
	readonly 'action-border-hover': 'var(--action-border-hover)';
	readonly 'action-foreground': 'var(--action-foreground)';
	readonly 'action-foreground-hover': 'var(--action-foreground-hover)';
	readonly 'callout-sienna-background': 'var(--callout-sienna-background)';
	readonly 'callout-sienna-border': 'var(--callout-sienna-border)';
	readonly 'callout-sienna-title': 'var(--callout-sienna-title)';
	readonly 'callout-sienna-description': 'var(--callout-sienna-description)';
	readonly 'callout-sienna-icon': 'var(--callout-sienna-icon)';
	readonly 'callout-aqua-background': 'var(--callout-aqua-background)';
	readonly 'callout-aqua-border': 'var(--callout-aqua-border)';
	readonly 'callout-aqua-title': 'var(--callout-aqua-title)';
	readonly 'callout-aqua-description': 'var(--callout-aqua-description)';
	readonly 'callout-aqua-icon': 'var(--callout-aqua-icon)';
	readonly 'control-icon-foreground': 'var(--control-icon-foreground)';
	readonly 'control-icon-foreground-contrast': 'var(--control-icon-foreground-contrast)';
};

export declare type StyleTailwindType =
...
export declare const Typography: {
	PERISCOPE_LINEHEIGHTMEDIUM: string;
	PERISCOPE_LINEHEIGHTBASE: string;
	PERISCOPE_FONTFAMILYSANS: string;
	PERISCOPE_FONTFAMILYSERIF: string;
	PERISCOPE_FONTFAMILYMONO: string;
	PERISCOPE_FONTWEIGHTREGULAR: string;
	PERISCOPE_FONTWEIGHTMEDIUM: string;
	PERISCOPE_FONTWEIGHTBOLD: string;
	PERISCOPE_FONTSIZELARGE: string;
