...
const onboardingConfigWithLinks = [
	...
	{
		dataSource: 'o11y-mcp-server',
		label: 'O11y MCP Server',
		tags: ['quickstart'],
		module: 'home',
		relatedSearchKeywords: [
			'agent',
	...
	{
		dataSource: 'migrate-o11y-self-host-to-cloud',
		label: 'From O11y Self-Host',
		tags: ['migrate to O11y'],
		module: 'home',
		relatedSearchKeywords: [
			'cloud',
			...
			'migrate',
			'migrate to o11y',
			'migrate-o11y-self-host-to-cloud',
			'migration',
			'self',
			'self-host',
			'self-host to cloud',
		...
		imgUrl: o11yBrandLogoUrl,
		link: '/docs/migration/migrate-from-o11y-self-host-to-o11y-cloud/',
	},
	{
		...
		link: '/docs/migration/migrate-from-opentelemetry-to-o11y/',
	},
	{
		dataSource: 'java',
		entityID: 'dataSource',
	...
	},
	{
		...
		id: 'convex-logs',
		link: '/docs/logs-management/send-logs/convex-log-streams-o11y/',
	},
	{
	...
	},
	{
		...
		id: 'vercel-logs',
		link: '/docs/userguide/vercel-to-o11y/',
	},
	{
		...
		id: 'heroku-logs',
		link: '/docs/userguide/heroku_logs_to_o11y/',
	},
	{
	...
	},
	{
		...
		id: 'fluentd',
		link: '/docs/userguide/fluentd_to_o11y/',
	},
	{
		...
		id: 'fluentbit',
		link: '/docs/userguide/fluentbit_to_o11y/',
	},
	{
		dataSource: 'logstash',
		label: 'Logstash',
		...
		id: 'logstash',
		link: '/docs/userguide/logstash_to_o11y/',
	},
	{
	...
	},
	{
		...
		id: 'vector-logs',
		link: '/docs/logs-management/send-logs/vector-logs-to-o11y/',
	},
	{
	...
	},
	{
		...
		link: '/docs/userguide/send-cloudwatch-logs-to-o11y/',
	},
	{
			...
			options: [
				{
					...
					label: 'Zerolog',
					imgUrl: logsUrl,
					link: '/docs/logs-management/send-logs/zerolog-to-o11y/',
				},
				{
					key: 'golang-logrus-logs',
					label: 'Logrus',
					imgUrl: logrusUrl,
					link: '/docs/logs-management/send-logs/logrus-to-o11y/',
				},
				{
					key: 'golang-zap-logs',
					label: 'Zap',
					imgUrl: zapUrl,
					link: '/docs/logs-management/send-logs/zap-to-o11y/',
				},
			],
		},
	},
	...
	},
	{
		...
		id: 'slog',
		link: '/docs/logs-management/send-logs/slog-to-o11y/',
	},
	{
		dataSource: 'scala',
		label: 'Scala',
