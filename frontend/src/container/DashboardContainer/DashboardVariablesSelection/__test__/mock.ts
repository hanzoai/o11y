...
export const buildDependenciesMock = {
	variables: [
		...
		},
		{
			...
			order: 1,
			queryValue:
				"SELECT DISTINCT JSONExtractString(labels, 'service_name') FROM observe_metrics.distributed_time_series_v4_1day\n WHERE metric_name = 'observe_calls_total' and JSONExtractString(labels, 'deployment_environment') = {{.deployment_environment}}",
		...
		},
		{
			...
			order: 2,
			queryValue:
				"SELECT DISTINCT JSONExtractString(labels, 'operation') FROM observe_metrics.distributed_time_series_v4_1day\n WHERE metric_name = 'observe_calls_total' AND JSONExtractString(labels, 'service_name') IN {{.service_name}} and JSONExtractString(labels, 'deployment_environment') = {{.deployment_environment}}",
			selectedValue: [
				'//v1/traces',
				'/logs/heroku',
				'/logs/json',
				...
				'/v1/traces',
				'SELECT',
				'exporter/o11ykafka/logs',
				'exporter/o11ykafka/metrics',
				'exporter/o11ykafka/traces',
				'extension/o11ykeyauth/Authenticate',
				'get',
				'hmget',
				'opentelemetry.proto.collector.logs.v1.LogsService/Export',
				'opentelemetry.proto.collector.metrics.v1.MetricsService/Export',
				'opentelemetry.proto.collector.trace.v1.TraceService/Export',
				'processor/o11ylimiter/LogsProcessed',
				'processor/o11ylimiter/MetricsProcessed',
				'processor/o11ylimiter/TracesProcessed',
				'receiver/otlp/LogsReceived',
				'receiver/otlp/MetricsReceived',
				'receiver/otlp/TraceDataReceived',
				'receiver/o11yhttplog/heroku/LogsReceived',
				'receiver/o11yhttplog/json/LogsReceived',
				'receiver/o11yhttplog/vector/LogsReceived',
				'redis.dial',
				'redis.pipeline eval',
				'sadd',
				'set',
		...
		},
		{
			...
			order: 3,
			queryValue:
				"SELECT DISTINCT JSONExtractString(labels, 'http_status_code') FROM observe_metrics.distributed_time_series_v4_1day\n WHERE metric_name = 'observe_calls_total' AND JSONExtractString(labels, 'operation') IN {{.endpoint}}",
			showALLOption: true,
			sort: 'ASC',
			textboxValue: '',
			type: 'QUERY',
		...
		},
		{
			...
			selectedValue: 'gke-o11y-saas-si-consumer-bsc-e2sd4-a6d430fa-gvm2',
			showALLOption: false,
			sort: 'DISABLED',
			textboxValue: '',
			type: 'QUERY',
