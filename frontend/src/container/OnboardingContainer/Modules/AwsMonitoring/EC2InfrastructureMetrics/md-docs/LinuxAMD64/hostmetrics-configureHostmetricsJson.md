...
Download/Copy the `hostmetrics.json` from [here](https://github.com/Hanzo O11y/dashboards/blob/main/hostmetrics/hostmetrics.json)

&nbsp;
&nbsp;

### Step 2: Import hostmetrics JSON file to Hanzo O11y Cloud
