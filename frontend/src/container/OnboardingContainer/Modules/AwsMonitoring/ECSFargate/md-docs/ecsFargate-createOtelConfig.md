...
### Step 1: 
Navigate to the AWS Parameter store and create a new parameter named **/ecs/hanzo/otelcol-sidecar.yaml**
...
Once you update these values, copy the updated content of the `otelcol-sidecar.yaml` file and paste it in the value field of the **/ecs/hanzo/otelcol-sidecar.yaml** parameter that you created in Step 1.
