...
To send traces data from applications deployed in ECS to Hanzo O11y Cloud using Daemon Service we created in the previous section, follow these steps:
...
### Step 5: Step 5: Verify Data in Hanzo O11y
