...
OTEL_EXPORTER_OTLP_HEADERS="hanzo-ingestion-key={{O11Y_INGESTION_KEY}}" \
...
If you encounter any difficulties, please consult the [troubleshooting section](https://o11y.hanzo.ai/docs/instrumentation/springboot/#troubleshooting-your-installation) for assistance.
