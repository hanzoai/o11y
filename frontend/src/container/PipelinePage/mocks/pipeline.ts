...
export const pipelineMockData: Array<PipelineData> = [
	{
		...
		createdBy: 'nityananda@o11y.hanzo.ai',
	...
	},
	{
		...
		createdBy: 'chintan@o11y.hanzo.ai',
...
export const pipelineApiResponseMockData: Pipeline = {
	...
	history: [
		...
		},
		{
			...
			version: 3,
			elementType: 'log_pipelines',
			createdBy: 'nityananda+1@o11y.hanzo.ai',
			active: false,
			isValid: false,
			disabled: false,
			deployStatus: 'IN_PROGRESS',
		...
		},
		{
			...
			version: 4,
			elementType: 'log_pipelines',
			createdBy: 'nityananda+2@o11y.hanzo.ai',
			active: false,
			isValid: false,
			disabled: false,
			deployStatus: 'IN_PROGRESS',
		...
		},
		{
			...
			version: 5,
			elementType: 'log_pipelines',
			createdBy: 'nityananda+4@o11y.hanzo.ai',
			active: false,
			isValid: false,
			disabled: false,
			deployStatus: 'IN_PROGRESS',
